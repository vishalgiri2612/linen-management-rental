...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    // Hardcoded for now since they are required by model but not in basic UI yet
  ...
  return (
    <div className="min-h-screen flex transition-colors font-sans bg-white dark:bg-gray-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden group">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/40 via-blue-900/40 to-black/60 mix-blend-multiply" />
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-20 text-white">
          ...
          <div className="animate-fade-in-up">
            <h2 className="text-6xl font-black leading-none mb-6 tracking-tighter">
              Start Your <br />
              <span className="text-blue-400 italic font-serif text-5xl font-normal">Journey Today</span>
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 relative bg-[#FDFCFB] dark:bg-gray-950">
        ...
        <div className="max-w-[440px] w-full relative z-10">
          <div className="mb-10">
            ...
            <h1 className="text-5xl font-black text-gray-900 dark:text-white tracking-tighter mb-4 leading-none text-left">
              Create <br /> Account
            </h1>
            <p className="text-gray-500 dark:text-gray-400 font-bold text-lg">
              Join thousands of hostelers enjoying premium rentals.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-900 shadow-2xl shadow-blue-900/5 dark:shadow-none p-1 transition-all">
            {/* Role Switcher */}
            <div className="flex p-2 bg-gray-50 dark:bg-gray-800 rounded-2xl mb-8 border border-gray-100 dark:border-gray-700">
              <button
            ...
            <form className="space-y-5" onSubmit={handleSignup}>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-black text-gray-900 dark:text-white mb-2 ml-1">First Name</label>
                  <input
                    type="text"
                    required
                    name="firstName"
                    placeholder="John"
                    className="w-full bg-gray-50 dark:bg-gray-800 border-2 border-transparent focus:border-blue-600/20 focus:bg-white dark:focus:bg-gray-800 rounded-2xl py-4 px-6 text-gray-900 dark:text-white focus:outline-none transition-all font-medium placeholder:text-gray-300 dark:placeholder:text-gray-600 shadow-inner"
                  />
                </div>
                <div>
                  <label className="block text-sm font-black text-gray-900 dark:text-white mb-2 ml-1">Last Name</label>
                  <input
                    type="text"
                    required
                    name="lastName"
              ...
              <div>
                <label className="block text-sm font-black text-gray-900 dark:text-white mb-2 ml-1">Password</label>
                <input
                  type="password"
                  required
                  name="password"
              ...
              <div className="flex items-center gap-3 px-1">
                <input type="checkbox" required className="rounded-md border-gray-200 dark:border-gray-700 text-blue-600 focus:ring-0 w-5 h-5 transition-all cursor-pointer" />
                <span className="text-xs font-bold text-gray-500 dark:text-gray-400">I agree to the <a href="#" className="underline">Terms & Conditions</a></span>
              </div>
            ...
            <button className="w-full mt-6 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-white font-bold py-4 rounded-2xl transition-all border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-3 shadow-sm active:scale-95">
          ...
          <div className="mt-10 text-center text-sm font-bold text-gray-500">
            ...
            <Link to="/login" className="text-gray-900 dark:text-white hover:text-blue-600 transition-colors underline underline-offset-4 font-black">
              Login Now
            </Link>
          </div>
        </div>
