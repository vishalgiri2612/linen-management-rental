            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-12 relative z-10">
              <div className="text-center md:text-left w-full flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="flex flex-col items-center md:items-start">
                  <span className="text-3xl font-black text-slate-900 dark:text-white italic tracking-tighter uppercase">
                    LINEN<span className="text-indigo-600">RENT.</span>
                  </span>
                  {selectedCity && (
               ...
               <p className="text-[10px] font-black text-slate-300 dark:text-slate-700 uppercase tracking-[0.8em]">Hostel Living. Reimagined.</p>
            </div>
          </footer>
        </div>
        </Router>
